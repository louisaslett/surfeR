...
timeout --kill-after=20s 10s docker run --rm -v /rserve/Rrunning:/rserve/Rrunning rocker/ml-verse:4.0.5 timeout --kill-after=20s 10s Rscript -e "rmarkdown::render('$d/${f%.R}.Rmd')"
